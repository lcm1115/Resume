...
\usepackage[left=.5in,right=.5in,top=.3in,bottom=0in,letterpaper]{geometry}
\usepackage{hyperref}
...
&\hspace{10pt}$\circ$ Assisted in social and professional development of students\\
&\hspace{10pt}$\circ$ Fostered a socially-inclusive environment for students\\
&\hspace{10pt}$\circ$ Hosted technical office hours to assist students with projects\\
&\\
